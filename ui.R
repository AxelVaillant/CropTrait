  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "visualization",h2("Database visualization"),
              wellPanel(fluidRow(column(width = 6,textInput("taxon","Taxon"),pickerInput("scale","Scale",c("Plant","Pot","Plot","Field")),
      ...
      tabItem(tabName = "downloadTab",h2("Get Data"),
              wellPanel(fluidRow(column(width = 6,textAreaInput("dlTaxon","Taxon"),pickerInput("dlScale","Scale",c("Plant","Pot","Plot","Field")),
                          ...
                          actionButton("runQuery","Download"))))),
